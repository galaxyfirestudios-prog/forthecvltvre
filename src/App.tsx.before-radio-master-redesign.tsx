      ...
      <main id="top">
        <section className="hero-grid">
          ...
          <div className="hero-visual">
            <img src={cultureArt} alt="For the Culture visual" fetchPriority="high" />
        ...
        <section className="radio-feature" aria-label="For the Culture live radio">
          ...
          <div className="radio-feature-copy"><span className="eyebrow">05 / LIVE RADIO</span><h2>THE SOUND<br /><em>NEVER STOPS.</em></h2><p>FOR THE CULTURE RADIO is the live audio layer of the Galaxy Fire ecosystem - built for records, stories, artists, conversations and the sounds moving the culture. Discover the voices shaping Nigeria, Africa and the diaspora, with a special ear for the next wave coming out of Abuja.</p><div className="radio-actions"><button type="button" className="primary-button" onClick={() => { setRadioOpen(true); startRadio(true); }}>▶ {radioPlaying ? "PLAYING LIVE" : "LISTEN LIVE"}</button><a className="secondary-button" href="#radio">VIEW SCHEDULE</a></div></div>
